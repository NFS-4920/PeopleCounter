...
#define DISTANCES_ARRAY_SIZE                         20   // nb of samples
#define MAX_DISTANCE                                 3000 // mm
#define MIN_DISTANCE                                 0   // mm
#define DIST_THRESHOLD                               1200  // mm
...
//End of workaround
  ...
  //xshutdown_top = new STMPE1600DigiOut(&DEV_I2C, 5, (0x42 * 2));
  //sensor_vl53l1_top = new VL53L1_X_NUCLEO_53L1A1(&DEV_I2C, xshutdown_top, A2);

  sensor_vl53l1_top = new VL53L1X(&DEV_I2C, XSHUT_PIN, GPIO1_PIN);
